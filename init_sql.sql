...
COURSELENGTH NUMBER(2) NOT NULL,
STATUS CHAR(6),
COUSEINFO CLOB,
...
SCORE NUMBER(2),
CONSTRAINT STUDENTFK FOREIGN KEY(STUDENTNO) REFERENCES STUDENT(STUDENTNO),
CONSTRAINT COURSENOFK FOREIGN KEY(COURSENO) REFERENCES COURSE(COURSENO),
CONSTRAINT SCORECHK CHECK(SCORE BETWEEN 0.0 AND 100.0)
);
